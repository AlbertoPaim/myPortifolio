...
import ScrollTriggered from "../components/Card";

const About = () => {
    return (
        <div id="about" className=" w-screen flex py-18 flex-col md:flex-row px-4 max-w-[1080px] justify-center mx-auto mt-16 gap-10">
